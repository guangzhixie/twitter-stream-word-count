...
################################################################################
twitter_credentials = {
    "consumer_key"        :  "MDcKvEHTC4940PDGhLPbB7s0s",
    "consumer_secret"     :  "MNYw1VgDFnzBNZtw5Dc8sbDNvxxGV5r0edsY8r9So0VdCmvmZ4",
    "access_token"        :  "32296109-BBY0QWLcfLs2cMBqPVMBdKjphrX2od5PRQyUY2Bb7",
    "access_token_secret" :  "svqNLkkTwse8Nf7H4WclSvLKVl32B5St5JRXMascJ7mxx",
}
...
class Tweets(Spout):
    ...
    def initialize(self, stormconf, context):
        ...
        stream.filter(languages=["en"], track=["donald", "trump", "hillary", "clinton", "election"], async=True)
